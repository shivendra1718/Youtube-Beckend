 ...
 /// now to login user
                ...
                const loginUser = asyncHandler(async (req,res)=>{
                   ...
                   const updateAccountDetails = asyncHandler(async(req,res)=>
                  {
                   ...
                   // avatar image upload 
                   /// TODO: assignment delete old avatr image after uploading
                  ...
                  const user =   await User.findByIdAndUpdate(req.user?._id, 
                   ...
                   return res.status(201).json(new ApiResponse(201,channel[0],"user channel fetched successfully"))
                   ...
                   const getWatchedHistory = asyncHandler(async(req,res) =>{
                    ...
                    return res.status(201).json(new ApiResponse(201,user[0].watchHistory,"user watchhistory is "))
...
export { registerUser, loginUser, logoutUser, refreshAccessToken, getCurrentUser, changeCurrentPassword, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchedHistory}